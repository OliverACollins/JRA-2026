    ...
    return new Promise(async function (resolve, reject) {
        try {
            ...
            for (let i = 0; i < 3; i++) {
                ...
                let resp = await fetch("http://192.168.0.52:5000/sync", { cache: "no-store" }) // change IPv4 address as appropriate
...
function sendMarker(value = "1") {
    ...
    if (lslBaseTime === null) {
        ...
        fetch("http://192.168.0.52:5000/marker?value=" + encodeURIComponent(value)) // change IPv4 address as appropriate
            .then(function () {
    ...
    var url = "http://192.168.0.52:5000/marker?value=" + encodeURIComponent(value) + "&ts=" + encodeURIComponent(ts) // change IPv4 address as appropriate
    fetch(url)
        .then(function () {
